        ...
        <div class="col-12">
            ...
            <p>Slang code is highly portable, but can still leverage unique platform capabilities, including the latest
                ...
                Direct3D and Vulkan. For example, developers can make full use of <a
                    href="external/slang/docs/user-guide/convenience-features#pointers-limited">pointers</a> when generating
                SPIR-V. Slang's <a href="external/slang/user-guide/03-capabilities.html">capability
