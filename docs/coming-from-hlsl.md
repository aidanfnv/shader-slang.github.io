...
For more detailed explanations on defining a custom interface, please refer to the [Slang User's Guide](external/slang/docs/user-guide/06-interfaces-generics).
...
For more details, please consult the [Slang User's Guide](external/slang/docs/user-guide/03-convenience-features)
...
For more details, please consult the [Slang User's Guide](external/slang/docs/user-guide/03-convenience-features#subscript-operator).
...
When you target SPIR-V, there are a few things that the user may want to know. Please check the [Slang User's Guide](external/slang/docs/user-guide/a2-01-spirv-target-specific) for more details.
